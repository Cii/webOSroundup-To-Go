...
(c) 2010 Syntactix, LLC. All rights reserved.
*/
...
var Metrix = Class.create(
{
  ...
  postDeviceDataSuccess: function(transport)
  {
  ...
  postDeviceDataFailure: function(transport)
  {
  ...
  storeCookie: function(lastBulletinTime,bulletinVersion)
  {
    if(lastBulletinTime)
    {
  ...
  isExpired: function(currentUtcTime, daysAllowed)
  {
  ...
  bulletinTimeCheck: function(controller, forceReview, url, response)
  {
  ...
  checkBulletinSuccess: function(timeUTC,controller, forceReview, transport)
  {
  ...
  checkBulletinFailure: function(transport)
  {
  },
  customCounts: function(valueGroup,valueName,valueData)
  {
  	...
  	{
	  	this.customCountsLock = window.setTimeout(function(){this.customCountsLock = null;}.bind(this),5000);
  ...
  customCountsSuccess: function(transport)
  {
  	
  },
  customCountsFailure: function(transport)
  {
...
BulletinAssistant.prototype.highlighter = function(btnSourceElement, btnTitleElement,mouseAction, btnType)
{
  if(mouseAction === "down")
  {
    ...
    {
      var srcString = this.sceneAssistant.controller.get(btnTitleElement).src;
...
BulletinAssistant.prototype.menuBarTouch = function(event)
{
  ...
  switch(target)
  {
    ...
    case "bltnPrevSelectorHitTarget":
      ...
      if(this.msgIndex === 0)
      {
        var srcString = this.sceneAssistant.controller.get("imgPrev").src;
